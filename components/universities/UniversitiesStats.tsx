...
const stats = [
  ...
  { value: 90, suffix: "+", label: "Universities We Apply To" },
  { value: null, suffix: "End-to-End", label: "Shortlist to Visa" },
  { value: null, suffix: "FBR·SECP", label: "Registered & Accredited" },
];
